...
<body>
    ...
    <div class="Flex flex-col items-center justify-center mt-10 px-70 m-auto space-y-6">
        ...
        <a href="{{ route('report') }}" class="flex flex-row items-center justify-center bg-transparent h-35 border border-b-black rounded-xl p-4 hover:border-blue-800 hover:bg-blue-800/10 transition-all duration-300 gap-2">
